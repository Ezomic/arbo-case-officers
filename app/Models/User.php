 ...
 */
#[Fillable(['id', 'name', 'email', 'first_name', 'last_name', 'phone_number', 'preferred_locale', 'timezone', 'current_role', 'tenant_id', 'accessible_apps', 'identity_synced_at', 'last_login_at', 'last_login_ip'])]
