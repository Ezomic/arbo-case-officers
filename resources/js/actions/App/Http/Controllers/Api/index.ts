...
const Api = {
    ...
    EmployerApiController: Object.assign(
    ...
    ContractApiController: Object.assign(
        ContractApiController,
        ContractApiController,
    ),
    OrganizationalUnitApiController: Object.assign(
        OrganizationalUnitApiController,
        OrganizationalUnitApiController,
    ),
    EmployeeApiController: Object.assign(
        EmployeeApiController,
        EmployeeApiController,
    ),
    EmployeeImportApiController: Object.assign(
        EmployeeImportApiController,
        EmployeeImportApiController,
    ),
};
