...
export const update = (
    args:
        | { case: string | { id: string }; note: string | { id: string } }
        | [caseParam: string | { id: string }, note: string | { id: string }],
    options?: RouteQueryOptions,
): RouteDefinition<'put'> => ({
...
update.url = (
    ...
    const parsedArgs = {
        case: typeof args.case === 'object' ? args.case.id : args.case,
        note: typeof args.note === 'object' ? args.note.id : args.note,
    };
 ...
 * @see app/Http/Controllers/CaseNoteController.php:63
 * @route '/cases/{case}/notes/{note}'
 */
