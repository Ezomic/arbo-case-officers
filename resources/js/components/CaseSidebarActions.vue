...
const page = usePage<{
    ...
    sidebarCaseTypes: CaseTypeOption[];
}>();
...
<template>
    ...
    >
        <DialogContent>
            ...
            >
                ...
                <div class="grid gap-2">
                    <Label for="sb_case_type">Dossier type</Label>
                    <select
                        id="sb_case_type"
                        name="case_type"
                        required
                    ...
                    >
                        ...
                        <option
                            v-for="type in page.props.sidebarCaseTypes"
                            :key="type.value"
                            :value="type.value"
                        >
                            {{ type.label }}
                ...
                <div class="grid gap-2">
                    <Label for="sb_start_date">Start date</Label>
                    <Input
                        id="sb_start_date"
                        type="date"
                        name="start_date"
    ...
    >
        <DialogContent>
            ...
            <Form
                v-else
                v-bind="updateRoute.form({ case: selectedCaseId })"
                v-slot="{ errors, processing }"
                class="space-y-4"
                @success="openDialog = null"
            >
                <div class="grid gap-2">
                    <Label for="sb_mut_case_id">Case</Label>
                    <select
                        id="sb_mut_case_id"
                ...
                <div class="grid gap-2">
                    <Label for="sb_mut_expected_return_date"
                        >Expected return date</Label
                    >
                    <Input
                        id="sb_mut_expected_return_date"
                        type="date"
    ...
    >
        <DialogContent>
            ...
            >
                <div class="grid gap-2">
                    <Label for="sb_rec_case_id">Case</Label>
                    <select
                        id="sb_rec_case_id"
                        v-model="selectedCaseId"
                        required
                ...
                <div class="grid gap-2">
                    <Label for="sb_rec_recovery_date">Recovery date</Label>
                    <Input
                        id="sb_rec_recovery_date"
                        type="date"
                        name="recovery_date"
                        :default-value="today"
                        required
